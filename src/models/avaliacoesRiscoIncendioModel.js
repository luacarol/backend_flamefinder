...
export async function atualizarAvaliacaoRiscoIncendio(id, novaAvaliacaoRiscoIncendio) {
    // Seleciona o banco de dados "FlameFinder"
    const db = conexao.db("FlameFinder");
    ...
    return colecao.updateOne({_id: new ObjectId(objID)}, {$set: novaAvaliacaoRiscoIncendio});
}